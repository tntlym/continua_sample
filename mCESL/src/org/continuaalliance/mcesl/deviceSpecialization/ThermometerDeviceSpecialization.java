...
/**
 * ThermometerDeviceSpecialization.java: This class represents Thermometer device specialization
 * 
 * @author Vignet
 */
...
public class ThermometerDeviceSpecialization extends MDSObject{

	public ThermometerDeviceSpecialization(Hashtable<Long, Attribute> map) {
		super(map);
		createNumericValues();
	}
	...
	private void createNumericValues()
	{
		...
		ASN_OIDType oid = new ASN_OIDType(Nomenclature.MDC_TEMP_BODY);
		...
		ASN_OIDType unitOid = new ASN_OIDType(Nomenclature.MDC_DIM_DEGC);
